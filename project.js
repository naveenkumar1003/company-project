  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link bg-violet" href="#">Find candidates <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
    ...
    <FontAwesomeIcon icon={faBell} /> <button class="mr-3 des" type="submit " >Login</button>
      <button class=" bg-violet des " type="submit">Register</button>
    </form>
  </div>
</nav> 
    
<h1 className="pt-5 text-violet">Find the candidates as per your requirement</h1>
<div className="container-fluid">
   ...
   <div className=" col-lg-12 place  text-center pt-2 ">
    ...
    <FontAwesomeIcon icon={faLocationDot} /> <input type="text" className="reg" placeholder="Add Country/City"/>
     <button className="bg-violet text-light reg "> Search</button>
     </div>
  ...
  <div className="container-fluid bg-secondary">
    ...
    <div className="col-lg-2">
     <div class="dropdown">
  <button class="btn-violet text-violet drop mark dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false">
    Experience 
  </button>
  ...
  <div className="container-fluid bg-secondary">
    <div className="row pt-3 justify-content-around text-center  ">
      ...
      <div className=" card m-1">
        ...
        <h1 className="text-center text-violet">{value.Title}</h1>
        <a className="  bg-violet px-3 text-light">View</a>
